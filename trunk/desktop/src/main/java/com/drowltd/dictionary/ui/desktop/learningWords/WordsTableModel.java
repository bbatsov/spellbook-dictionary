 ...
 * @see #getDataVector
 */
public class WordsTableModel extends AbstractTableModel implements Serializable {
...
//
     ...
     * @see #setValueAt
     */
    public WordsTableModel(int rowCount, int columnCount) {
     ...
     * @see #setValueAt
     */
    public WordsTableModel(Vector columnNames, int rowCount) {
     ...
     * @see #setValueAt
     */
    public WordsTableModel(Object[] columnNames, int rowCount) {
     ...
     * @see #setDataVector
     */
    public WordsTableModel(Vector data, Vector columnNames) {
     ...
     * @see #setDataVector
     */
    public WordsTableModel(Object[][] data, Object[] columnNames) {
        setDataVector(data, columnNames);
    }
